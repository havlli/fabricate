...
public final class ChineseLocale implements LocaleData {
    ...
    private static final List<String> EMAIL_DOMAINS = List.of(
            ...
            "sohu.com", "tom.com", "yeah.net", "21cn.com", "aliyun.com"
    );

    private static final List<String> PHONE_COUNTRY_CODES = List.of(
            "+86", "+852", "+853", "+886", "+81", "+82", "+65", "+66"
    );
    ...
    @Override public Locale locale() { return Locale.CHINESE; }
